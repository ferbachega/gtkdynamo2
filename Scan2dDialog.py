...
class Scan2dDialog():
    ...
    def change_COMBOBOX_COOD1(self, combobox):
        """ Function doc """
        
        method = self.builder.get_object('Scan2dDialog_combobox_SCAN2D_reaction_coordiante1').get_active_text()
        if method == "simple-distance":
            self.builder.get_object("Scan2dDialog_scan2d_label_coord1_atom3").set_sensitive(False)
            self.builder.get_object("Scan2dDialog_scan2d_entry_ATOM3").set_sensitive(False)
            self.builder.get_object("Scan2dDialog_scan2d_label_cood1_ATOM3_name").set_sensitive(False)
            self.builder.get_object("Scan2dDialog_scan2d_entry_cood1_ATOM3_name").set_sensitive(False)
            self.builder.get_object("Scan2dDialog_scan2d_checkbox_mass_weight_coord1").set_sensitive(False)
            #print texto_d1
            #self.builder.get_object('19_window_label1').set_text("Define atoms using pk1 and pk2 selections")
        if method == "multiple-distance":
            self.builder.get_object("Scan2dDialog_scan2d_label_coord1_atom3").set_sensitive(True)
            self.builder.get_object("Scan2dDialog_scan2d_entry_ATOM3").set_sensitive(True)
            self.builder.get_object("Scan2dDialog_scan2d_label_cood1_ATOM3_name").set_sensitive(True)
            self.builder.get_object("Scan2dDialog_scan2d_entry_cood1_ATOM3_name").set_sensitive(True)
            self.builder.get_object("Scan2dDialog_scan2d_checkbox_mass_weight_coord1").set_sensitive(True)

    def change_COMBOBOX_COOD2(self, combobox):
        """ Function doc """
        
        method = self.builder.get_object('Scan2dDialog_combobox_SCAN2D_reaction_coordiante2').get_active_text()
        if method == "simple-distance":
            self.builder.get_object("Scan2dDialog_scan2d_label_coord2_atom3").set_sensitive(False)
            self.builder.get_object("Scan2dDialog_scan2d_entry_coord2_ATOM3").set_sensitive(False)
            self.builder.get_object("Scan2dDialog_scan2d_label_cood2_ATOM3_name").set_sensitive(False)
            self.builder.get_object("Scan2dDialog_scan2d_entry_cood2_ATOM3_name").set_sensitive(False)
            self.builder.get_object("Scan2dDialog_scan2d_checkbox_mass_weight_coord2").set_sensitive(False)

            #print texto_d1
            
            #self.builder.get_object('19_window_label1').set_text("Define atoms using pk1 and pk2 selections")
        if method == "multiple-distance":
            self.builder.get_object("Scan2dDialog_scan2d_label_coord2_atom3").set_sensitive(True)
            self.builder.get_object("Scan2dDialog_scan2d_entry_coord2_ATOM3").set_sensitive(True)
            self.builder.get_object("Scan2dDialog_scan2d_label_cood2_ATOM3_name").set_sensitive(True)
            self.builder.get_object("Scan2dDialog_scan2d_entry_cood2_ATOM3_name").set_sensitive(True)
            self.builder.get_object("Scan2dDialog_scan2d_checkbox_mass_weight_coord2").set_sensitive(True)

    

    def Scan2dDialog_button_import_PyMOL_data (self, button):
        if button == self.builder.get_object('Scan2dDialog_scan2d_button_import_index1'):
            print 'checkbutton_MassWeight1'
            mode        =  self.builder.get_object('Scan2dDialog_combobox_SCAN2D_reaction_coordiante1').get_active_text()

            if mode == "simple-distance":
                try:
                    name1, atom1_index, name2, atom2_index, distance_a1_a2 = import_ATOM1_ATOM2("pk1", "pk2")
                    distance_a1_a2 = str(distance_a1_a2)
                    self.builder.get_object('Scan2dDialog_scan2d_entry_coord1_DMINIMUM').set_text(distance_a1_a2)
                                             
                    self.builder.get_object("Scan2dDialog_scan2d_entry_ATOM1").set_text(str(atom1_index))
                    self.builder.get_object("Scan2dDialog_scan2d_entry_cood1_ATOM1_name").set_text(name1)
                    self.builder.get_object("Scan2dDialog_scan2d_entry_ATOM2").set_text(str(atom2_index))
                    self.builder.get_object("Scan2dDialog_scan2d_entry_cood1_ATOM2_name").set_text(name2)
                except:
                    #cmd.edit_mode()
            ...
            if mode == "multiple-distance":			
                try:
                    ...
                    if self.builder.get_object("Scan2dDialog_scan2d_checkbox_mass_weight_coord1").get_active():
                        ...
                        self.builder.get_object('Scan2dDialog_scan2d_entry_coord1_DMINIMUM').set_text(str(DMINIMUM))
                ...
                self.builder.get_object("Scan2dDialog_scan2d_entry_ATOM2").set_text(str(atom2_index))
                self.builder.get_object("Scan2dDialog_scan2d_entry_cood1_ATOM2_name").set_text(name2)
                self.builder.get_object("Scan2dDialog_scan2d_entry_ATOM3").set_text(str(atom3_index))
                self.builder.get_object("Scan2dDialog_scan2d_entry_cood1_ATOM3_name").set_text(name3)

        
        
        if button == self.builder.get_object('Scan2dDialog_scan2d_button_import_index2'):
            print 'checkbutton_MassWeight2' 
            
            mode        =  self.builder.get_object('Scan2dDialog_combobox_SCAN2D_reaction_coordiante2').get_active_text()
            if mode == "simple-distance":
                try:
                    name1, atom1_index, name2, atom2_index, distance_a1_a2 = import_ATOM1_ATOM2("pk1", "pk2")
                    distance_a1_a2 = str(distance_a1_a2)
                    self.builder.get_object('Scan2dDialog_scan2d_entry_coord2_DMINIMUM').set_text(distance_a1_a2)
                    
                    self.builder.get_object("Scan2dDialog_scan2d_entry_coord2_ATOM1").set_text(str(atom1_index))
                    self.builder.get_object("Scan2dDialog_scan2d_entry_cood2_ATOM1_name").set_text(name1)
                    self.builder.get_object("Scan2dDialog_scan2d_entry_coord2_ATOM2").set_text(str(atom2_index))
                    self.builder.get_object("Scan2dDialog_scan2d_entry_cood2_ATOM2_name").set_text(name2)
                except:
                    print texto_d1
            ...
            if mode == "multiple-distance":
                try:						
                    ...
                    if self.builder.get_object("Scan2dDialog_scan2d_checkbox_mass_weight_coord2").get_active():
                        ...
                        self.builder.get_object('Scan2dDialog_scan2d_entry_coord2_DMINIMUM').set_text(str(DMINIMUM))
                ...
                self.builder.get_object("Scan2dDialog_scan2d_entry_coord2_ATOM2").set_text(str(atom2_index))
                self.builder.get_object("Scan2dDialog_scan2d_entry_cood2_ATOM2_name").set_text(name2)
                self.builder.get_object("Scan2dDialog_scan2d_entry_coord2_ATOM3").set_text(str(atom3_index))
                self.builder.get_object("Scan2dDialog_scan2d_entry_cood2_ATOM3_name").set_text(name3)



    def Scan2dDialog_checkbutton_MassWeight (self, checkbutton):
        """ Function doc """
        
        if checkbutton == self.builder.get_object('Scan2dDialog_scan2d_checkbox_mass_weight_coord1'):
            print 'checkbutton_MassWeight1'
        if checkbutton == self.builder.get_object('Scan2dDialog_scan2d_checkbox_mass_weight_coord2'):
            print 'checkbutton_MassWeight2'
    ...
    def __init__(self, project=None, window_control=None, main_builder=None):
        ...
        self.builder.add_from_file(
            os.path.join(GTKDYNAMO_GUI, 'Scan2dDialog.glade'))
        
        self.builder.connect_signals(self)
        self.dialog = self.builder.get_object('Scan2dDialog')
        ...
        #--------------------- Setup ComboBoxes -------------------------
        combobox  = 'Scan2dDialog_combobox_SCAN2D_reaction_coordiante1'                                           
        combolist = ['simple-distance', 'multiple-distance']
        self.window_control.SETUP_COMBOBOXES(combobox, combolist, 0)     
        
        combobox  = 'Scan2dDialog_combobox_SCAN2D_reaction_coordiante2'                                           
        combolist = ['simple-distance', 'multiple-distance']
        self.window_control.SETUP_COMBOBOXES(combobox, combolist, 0) 


        combobox  = 'Scan2dDialog_combobox_SCAN2D_minimization_method'                                           
