...
def install_pyGTK ( system = 'debian'):
    """ Function doc """
        ...
        if s in answer:
            ...
            if system == 'debian':
                try:
                    ...
                    print 'sudo apt-get install python-gtk2 - Failed'
            ...
            if system == 'suse':
                try:
                    ...
                    print 'sudo zypper install python-gtk - Failed'
        
        else:
            pass
            

def install_GTK ( system = 'debian'):
    print "\nChecking GTK"
...
def install_PyMOL (system = 'debian'):
    """
           #-----------------------------------#
           #                                   #
           #               PYMOL               #
...
def install_matplotlib (system = 'debian'):
    """ Function doc """
...
def install_pDynamo (system = None):
    """ Function doc """
...
def install_EasyHybrid (gtkdyn_folder = None, ):
    """ Function doc """
