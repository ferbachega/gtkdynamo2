...
class ImportCoordinatesDialog():
    ...
    def on_on_button_import_coordinates_clicked(self, button):
		...
		self.project.From_PDYNAMO_to_EasyHybrid(type_='Coord', log =  None)
    ...
    def __init__(self, EasyHybridSession = None):
        ...
        self.builder.add_from_file(
            os.path.join(self.EasyHybrid_GUI,'DialogChargeRescale', 'ImportCoordinates.glade'))
...
class ExportCoordinatesDialog():
    ...
    def __init__(self, EasyHybridSession = None):
		...
		self.builder.add_from_file(
			os.path.join(self.EasyHybrid_GUI,'DialogChargeRescale','ExportCoordinates.glade'))
		self.builder.connect_signals(self)
